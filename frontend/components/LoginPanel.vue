<template>
  <div class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
    <div class="card p-8 max-w-md mx-auto relative">
      ...
      <div class="space-y-6">
        ...
        <div class="space-y-4">
          ...
          <a :href="facebookLoginUrl" class="w-full flex justify-center items-center px-4 py-3 border border-gray-300 rounded-lg shadow-sm bg-white text-gray-700 hover:bg-gray-50 transition-colors duration-200 font-medium">
